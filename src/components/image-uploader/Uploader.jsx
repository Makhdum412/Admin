      ...
      files.forEach((file) => {
        ...
        axios({
          ...
          .then((res) => {
            ...
            setLoading(false);
            console.log("Upload response:", res.data.secure_url);
            if (product) {
              setImageUrl((imgUrl) => {
                const newImageUrl = [...imgUrl, res.data.secure_url];
                console.log("Updated imageUrl (product):", newImageUrl);
                return newImageUrl;
              });
            } else {
              console.log("Setting single imageUrl:", res.data.secure_url);
